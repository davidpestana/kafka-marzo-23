...
public class SimpleProducer {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, Ejemplo03StreamsTopology.KAFKA_SERVERS);
        ...
        for (int id = 0; id < 5000; id++) {
            ...
            producer.send(new ProducerRecord<>(Ejemplo03StreamsTopology.TOPIC_ORIGEN, key, message));
            Thread.sleep(1000);
        }
